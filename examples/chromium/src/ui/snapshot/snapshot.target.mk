...
OBJS := \
	$(obj).target/$(TARGET)/ui/snapshot/snapshot_gtk.o
...
$(obj).target/ui/snapshot/libsnapshot.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/ui/snapshot/libsnapshot.a: LIBS := $(LIBS)
$(obj).target/ui/snapshot/libsnapshot.a: TOOLSET := $(TOOLSET)
$(obj).target/ui/snapshot/libsnapshot.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink_thin)

all_deps += $(obj).target/ui/snapshot/libsnapshot.a
# Add target alias
.PHONY: snapshot
snapshot: $(obj).target/ui/snapshot/libsnapshot.a
