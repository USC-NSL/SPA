...
#define CONFIG_CODE_NONZEROCOUNT 0
#define CONFIG_USESELECTREFMV 0
#define CONFIG_MODELCOEFPROB 0
#define CONFIG_LOOP_DERING 0
#define CONFIG_IMPLICIT_COMPOUNDINTER_WEIGHT 0
#define CONFIG_SCATTERSCAN 0
#endif /* VPX_CONFIG_H */
