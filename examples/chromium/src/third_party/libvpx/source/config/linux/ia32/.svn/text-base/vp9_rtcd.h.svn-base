...
RTCD_EXTERN void (*vp9_recon2b)(uint8_t *pred_ptr, int16_t *diff_ptr, uint8_t *dst_ptr, int stride);
...
RTCD_EXTERN void (*vp9_recon4b)(uint8_t *pred_ptr, int16_t *diff_ptr, uint8_t *dst_ptr, int stride);
...
RTCD_EXTERN void (*vp9_loop_filter_mbv)(uint8_t *y, uint8_t *u, uint8_t *v, int ystride, int uv_stride, struct loop_filter_info *lfi);
...
RTCD_EXTERN void (*vp9_loop_filter_bv)(uint8_t *y, uint8_t *u, uint8_t *v, int ystride, int uv_stride, struct loop_filter_info *lfi);
...
RTCD_EXTERN void (*vp9_loop_filter_bv8x8)(uint8_t *y, uint8_t *u, uint8_t *v, int ystride, int uv_stride, struct loop_filter_info *lfi);
...
RTCD_EXTERN void (*vp9_loop_filter_mbh)(uint8_t *y, uint8_t *u, uint8_t *v, int ystride, int uv_stride, struct loop_filter_info *lfi);
...
RTCD_EXTERN void (*vp9_loop_filter_bh)(uint8_t *y, uint8_t *u, uint8_t *v, int ystride, int uv_stride, struct loop_filter_info *lfi);
...
RTCD_EXTERN void (*vp9_loop_filter_bh8x8)(uint8_t *y, uint8_t *u, uint8_t *v, int ystride, int uv_stride, struct loop_filter_info *lfi);
...
RTCD_EXTERN void (*vp9_loop_filter_simple_mbv)(uint8_t *y, int ystride, const uint8_t *blimit);
...
RTCD_EXTERN void (*vp9_loop_filter_simple_mbh)(uint8_t *y, int ystride, const uint8_t *blimit);
...
RTCD_EXTERN void (*vp9_loop_filter_simple_bv)(uint8_t *y, int ystride, const uint8_t *blimit);
...
RTCD_EXTERN void (*vp9_loop_filter_simple_bh)(uint8_t *y, int ystride, const uint8_t *blimit);
...
RTCD_EXTERN void (*vp9_lpf_mbh_w)(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr, int y_stride, int uv_stride, struct loop_filter_info *lfi);
...
RTCD_EXTERN void (*vp9_lpf_mbv_w)(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr, int y_stride, int uv_stride, struct loop_filter_info *lfi);
...
RTCD_EXTERN void (*vp9_post_proc_down_and_across)(uint8_t *src_ptr, uint8_t *dst_ptr, int src_pixels_per_line, int dst_pixels_per_line, int rows, int cols, int flimit);
...
RTCD_EXTERN unsigned int (*vp9_sad16x3)(const uint8_t *src_ptr, int  src_stride, const uint8_t *ref_ptr, int ref_stride);
...
static void setup_rtcd_internal(void)
{
    ...
    if (flags & HAS_SSE2) vp9_copy_mem16x16 = vp9_copy_mem16x16_sse2;
    ...
    if (flags & HAS_SSE2) vp9_recon2b = vp9_recon2b_sse2;

    vp9_recon4b = vp9_recon4b_c;
    if (flags & HAS_SSE2) vp9_recon4b = vp9_recon4b_sse2;
    ...
    vp9_loop_filter_bv = vp9_loop_filter_bv_c;
    if (flags & HAS_SSE2) vp9_loop_filter_bv = vp9_loop_filter_bv_sse2;

    vp9_loop_filter_bv8x8 = vp9_loop_filter_bv8x8_c;
    if (flags & HAS_SSE2) vp9_loop_filter_bv8x8 = vp9_loop_filter_bv8x8_sse2;

    vp9_loop_filter_mbh = vp9_loop_filter_mbh_c;
    if (flags & HAS_SSE2) vp9_loop_filter_mbh = vp9_loop_filter_mbh_sse2;

    vp9_loop_filter_bh = vp9_loop_filter_bh_c;
    if (flags & HAS_SSE2) vp9_loop_filter_bh = vp9_loop_filter_bh_sse2;

    vp9_loop_filter_bh8x8 = vp9_loop_filter_bh8x8_c;
    if (flags & HAS_SSE2) vp9_loop_filter_bh8x8 = vp9_loop_filter_bh8x8_sse2;

    vp9_loop_filter_simple_mbv = vp9_loop_filter_simple_vertical_edge_c;
    if (flags & HAS_MMX) vp9_loop_filter_simple_mbv = vp9_loop_filter_simple_vertical_edge_mmx;
    if (flags & HAS_SSE2) vp9_loop_filter_simple_mbv = vp9_loop_filter_simple_vertical_edge_sse2;

    vp9_loop_filter_simple_mbh = vp9_loop_filter_simple_horizontal_edge_c;
    if (flags & HAS_MMX) vp9_loop_filter_simple_mbh = vp9_loop_filter_simple_horizontal_edge_mmx;
    if (flags & HAS_SSE2) vp9_loop_filter_simple_mbh = vp9_loop_filter_simple_horizontal_edge_sse2;

    vp9_loop_filter_simple_bv = vp9_loop_filter_bvs_c;
    if (flags & HAS_MMX) vp9_loop_filter_simple_bv = vp9_loop_filter_bvs_mmx;
    if (flags & HAS_SSE2) vp9_loop_filter_simple_bv = vp9_loop_filter_bvs_sse2;

    vp9_loop_filter_simple_bh = vp9_loop_filter_bhs_c;
    if (flags & HAS_MMX) vp9_loop_filter_simple_bh = vp9_loop_filter_bhs_mmx;
    if (flags & HAS_SSE2) vp9_loop_filter_simple_bh = vp9_loop_filter_bhs_sse2;

    vp9_lpf_mbh_w = vp9_lpf_mbh_w_c;
    if (flags & HAS_SSE2) vp9_lpf_mbh_w = vp9_lpf_mbh_w_sse2;

    vp9_lpf_mbv_w = vp9_lpf_mbv_w_c;
    if (flags & HAS_SSE2) vp9_lpf_mbv_w = vp9_lpf_mbv_w_sse2;
    ...
    vp9_sad16x3 = vp9_sad16x3_c;
    if (flags & HAS_SSE2) vp9_sad16x3 = vp9_sad16x3_sse2;

    vp9_sad3x16 = vp9_sad3x16_c;
    if (flags & HAS_SSE2) vp9_sad3x16 = vp9_sad3x16_sse2;
