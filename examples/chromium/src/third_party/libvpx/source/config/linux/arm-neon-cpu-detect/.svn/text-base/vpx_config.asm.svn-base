...
.equ CONFIG_CODE_NONZEROCOUNT ,  0
.equ CONFIG_USESELECTREFMV ,  0
.equ CONFIG_MODELCOEFPROB ,  0
.equ CONFIG_LOOP_DERING ,  0
.equ CONFIG_IMPLICIT_COMPOUNDINTER_WEIGHT ,  0
.equ CONFIG_SCATTERSCAN ,  0
