...
OBJS := \
	$(obj).target/$(TARGET)/components/visitedlink/renderer/visitedlink_slave.o
...
$(obj).target/components/libvisitedlink_renderer.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/components/libvisitedlink_renderer.a: LIBS := $(LIBS)
$(obj).target/components/libvisitedlink_renderer.a: TOOLSET := $(TOOLSET)
$(obj).target/components/libvisitedlink_renderer.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink_thin)

all_deps += $(obj).target/components/libvisitedlink_renderer.a
# Add target alias
.PHONY: visitedlink_renderer
visitedlink_renderer: $(obj).target/components/libvisitedlink_renderer.a

# Add target alias to "all" target.
.PHONY: all
all: visitedlink_renderer
