...
extra_cmd = ' -DTORRENT_NO_DEPRECATE  -DTORRENT_DISABLE_ENCRYPTION  -DTORRENT_DISABLE_GEO_IP  -DBOOST_ASIO_HASH_MAP_BUCKETS=1021  -DBOOST_EXCEPTION_DISABLE  -DBOOST_ASIO_ENABLE_CANCELIO  -DBOOST_ASIO_DYN_LINK -I/usr/include  -lpthread   -lboost_system  -lpthread    '
...
setup( name='python-libtorrent',
	...
	ext_modules = [Extension('libtorrent',
		...
		extra_link_args = '-L/usr/lib/x86_64-linux-gnu '.split() + arch(),
