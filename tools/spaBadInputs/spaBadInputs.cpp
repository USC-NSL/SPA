...
// 			assert( cp->hasOutput( clientOutName ) && "Server consumes a message type not generated by client." );
			if ( ! cp->hasOutput( clientOutName ) ) {
				std::cerr << "	Server consumes a message type not generated by client: " << type << std::endl;
				return false;
			}
...
// 			std::cerr << "	Connecting message type: " << type << std::endl;
			...
			assert( sp->hasOutput( serverOutName ) && "Client consumes a message type not generated by server." );
